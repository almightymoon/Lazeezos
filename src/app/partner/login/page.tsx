      ...
      <div className="flex-1 flex items-center justify-center p-8 relative overflow-hidden">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">Sign in to continue managing your restaurant</p>
          </div>
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden bg-gradient-to-br from-orange-500 via-pink-500 to-purple-600">
        ...
        <div className="relative z-10 flex flex-col justify-center p-16 text-white">
          ...
          <p className="text-xl opacity-90 mb-8 leading-relaxed">
            Manage your restaurant, track orders, and grow your business with Lazeezos. 
