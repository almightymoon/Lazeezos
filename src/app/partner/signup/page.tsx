      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden bg-gradient-to-br from-orange-500 via-pink-500 to-purple-600">
        ...
        <div className="relative z-10 flex flex-col justify-center p-16 text-white">
          {/* <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-sm mb-8 w-fit">
            ...
            <span>Join 10,000+ Successful Restaurants</span>
          </div> */}
          ...
          <p className="text-xl opacity-90 mb-12 leading-relaxed max-w-md">
            Create your restaurant account and start reaching more customers. 
            Grow your business with our powerful platform and dedicated support.
          </p>
        ...
        <div className="w-full max-w-2xl relative z-10">
          ...
          <Card className="p-6 shadow-2xl border-2">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <Label htmlFor="ownerName" className="text-base font-medium">Owner Name *</Label>
                <Input
                  id="ownerName"
                  required
              ...
              <div>
                <Label htmlFor="address" className="text-base font-medium">Restaurant Address *</Label>
                <Input
                  id="address"
                  required
